...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"back"] style:(UIBarButtonItemStylePlain) target:self action:@selector(leftBarButtonItemAction)];
    CALayer * layerView = [[CALayer alloc]init];
    layerView.backgroundColor = kRedColor.CGColor;
    layerView.frame = CGRectMake(0, 0, screenWidth, 64);
    [self.view.layer insertSublayer:layerView atIndex:1];
}
